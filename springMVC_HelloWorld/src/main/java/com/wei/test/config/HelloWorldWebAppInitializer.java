...
public class HelloWorldWebAppInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	protected void customizeRegistration(ServletRegistration.Dynamic registration) {
		registration.setMultipartConfig(new MultipartConfigElement("/tmp/web/test", 2097152, 4194304, 0));
	}
/*
    ...
    private static final String LOCATION = "/tmp/web/test/"; // Temporary location where files will be stored
